...
function CourseList() {
  ...
  return (
    <div className='mt-10'>
        <h2 className='font-bold text-2xl flex justify-between items-center'>Your Personal Courses
            <Button variant="outline" 
            onClick={GetCourseList}
            className="bg-orange-500 border-primary text-primary"> <RefreshCw/>Refresh</Button>
        </h2>
