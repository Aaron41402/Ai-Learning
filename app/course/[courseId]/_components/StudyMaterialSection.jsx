...
function StudyMaterialSection({courseId, course}) {
  ...
  const MaterialList = [
    ...
    },
    {
      ...
      title: 'Flashcard',
      src: '/other.png',
      ctaText: 'View Flashcards',
      ctaLink: `/course/${courseId}/flashcards`,
      type: 'flashcard'
    },
    {
      name: 'Quiz',
      description: 'Quiz help to test your knowledge',
      title: 'Quiz',
      src: '/code.png',
      ctaText: 'Take Quiz',
      ctaLink: `/course/${courseId}/quiz`,
      type: 'quiz'
    },
    {
      name: 'Q/A',
      description: 'Q/A help to practice your learning',
      title: 'Q/A',
      src: '/language.png',
      ctaText: 'View Q/A',
      ctaLink: `/course/${courseId}/qa`,
      type: 'qa'
    }
  ];
  ...
  return (<>
    ...
    <div className='mt-5'>
      ...
      <ul className="max-w-2xl mx-auto w-full gap-4 mt-3">
        {MaterialList.map((card, index) => (
          <motion.div
            ...
            <Link href={card.ctaLink}>
              <motion.button
                ...
                className="px-4 py-2 text-sm rounded-full font-bold bg-orange-500 hover:bg-orange-500 hover:text-white text-black mt-4 md:mt-0">
                {card.ctaText}
              </motion.button>
            </Link>
          </motion.div>
